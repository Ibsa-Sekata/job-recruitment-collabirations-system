...
// Handle employer approval/rejection and admin management
...
<body>
        ...
        <div class="card mb-5">
            ...
            <div class="employer-table">
                ...
                <div class="table-row">
                    ...
                    <div>
                        <span class="status-badge <?= $admin['role'] === 'super_admin' ? 'status-approved' : 'status-pending' ?>">
        ...
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 2rem; border-radius: 0.5rem; width: 90%; max-width: 500px;">
            ...
            <form method="POST" id="rejectForm">
                ...
                <div class="form-group">
                    ...
                    <textarea name="reason" id="reason" class="input" rows="3" placeholder="Enter reason for rejection..."></textarea>
                </div>
    ...
    <?php if ($isSuperAdmin): ?>
    <div id="createAdminModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000;">
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 2rem; border-radius: 0.5rem; width: 90%; max-width: 500px;">
